	...
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
        ...
        <view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
			...
			<view v-if="queryIndex==0" class="search-form round">
				...
				<input v-model="searchForm.jiaoshigonghao" type="text" placeholder="教师工号" ></input>
			</view>
			...
			<view v-if="queryIndex==2" class="search-form round">
				<text class="cuIcon-search"></text>
				<input v-model="searchForm.lianxidianhua" type="text" placeholder="联系电话" ></input>
			</view>
			<view class="action">
		...
		<button v-if="isAuth('jiaoshi','新增')" class="add-btn" @click="onAddTap()">新增</button>
			...
			async search(){
				...
				let searchForm = {
					...
					searchForm['jiaoshixingming'] = '%' + this.searchForm.jiaoshixingming + '%'
																																								...
																																								if(this.searchForm.lianxidianhua){
					searchForm['lianxidianhua'] = '%' + this.searchForm.lianxidianhua + '%'
				}	
