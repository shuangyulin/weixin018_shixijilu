          ...
          <el-form-item class="input" label="教师姓名" prop="jiaoshixingming">
              <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="教师姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="打卡人数" prop="dakarenshu">
          <el-input v-model="ruleForm.dakarenshu" 
              placeholder="打卡人数" clearable  :readonly="ro.dakarenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="打卡人数" prop="dakarenshu">
              <el-input v-model="ruleForm.dakarenshu" 
                placeholder="打卡人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="未打卡人数" prop="weidakarenshu">
          <el-input v-model="ruleForm.weidakarenshu" 
              placeholder="未打卡人数" clearable  :readonly="ro.weidakarenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="未打卡人数" prop="weidakarenshu">
              <el-input v-model="ruleForm.weidakarenshu" 
                placeholder="未打卡人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dakarenshu = true;
            continue;
	            	            ...
	            	            if(o=='weidakarenshu'){
            this.ruleForm.weidakarenshu = obj[o];
	    this.ro.weidakarenshu = true;
            continue;
          }
	            	            if(o=='beizhu'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `dakajilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dakajiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
