    ...
    >  
     <el-row>
        ...
        <el-form-item v-if="flag=='xuesheng'" label="教师工号" prop="jiaoshigonghao">
          <el-select  @change="xueshengjiaoshigonghaoChange" v-model="ruleForm.jiaoshigonghao" placeholder="请选择教师工号">
            <el-option
    ...
    this.$http({
      ...
      if (data && data.code === 0) {
        ...
        this.$message.error(data.msg);
                ...
                this.$http({
      url: `option/zhuanyexinxi/zhuanye`,
      method: "get"
    }).then(({ data }) => {
      if (data && data.code === 0) {
