  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(225, 225, 225, 1);borderRadius:26px">
        <h1 class="h1" style="color:rgba(244, 91, 75, 1);fontSize:28px;">实习记录小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="教师姓名" class="input" v-if="tableName=='xuesheng'">
			...
			<el-form-item label="教师邮箱" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaoshiyouxiang" autocomplete="off" placeholder="教师邮箱" type="text" />
			</el-form-item>
